...
class ProcurementLog(models.Model):
    ...
    Uses F() expressions for race-condition-safe stock updates.
    """
...
class Payment(models.Model):
    ...
    Uses F() expressions for race-condition-safe balance updates.
    """
...
class SupplyLog(models.Model):
    ...
    Uses F() expressions for race-condition-safe stock/balance updates.
    """
...
class BreakageLog(models.Model):
    ...
    Use cases:
    - Blocks broken during stacking
    - Rain/weather damage
    - Site accidents
    - Improper handling
    - Production defects discovered later
