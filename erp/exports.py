...
class ReportExporter:
    ...
    def export_sales_csv(self):
        ...
        response['Content-Disposition'] = f'attachment; filename="sales_report_{self.start_date}_to_{self.end_date}.csv"'
    ...
    def export_sales_excel(self):
        ...
        response['Content-Disposition'] = f'attachment; filename="sales_report_{self.start_date}_to_{self.end_date}.xlsx"'
        wb.save(response)
        return response
    ...
    def export_expenses_csv(self):
        ...
        response = HttpResponse(content_type='text/csv')
        response['Content-Disposition'] = f'attachment; filename="expenses_report_{self.start_date}_to_{self.end_date}.csv"'
    ...
    def export_expenses_excel(self):
        ...
        response = HttpResponse(content_type='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
        response['Content-Disposition'] = f'attachment; filename="expenses_report_{self.start_date}_to_{self.end_date}.xlsx"'
        wb.save(response)
        return response
    ...
    def export_production_csv(self):
        ...
        response = HttpResponse(content_type='text/csv')
        response['Content-Disposition'] = f'attachment; filename="production_report_{self.start_date}_to_{self.end_date}.csv"'
    ...
    def export_production_excel(self):
        ...
        response = HttpResponse(content_type='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
        response['Content-Disposition'] = f'attachment; filename="production_report_{self.start_date}_to_{self.end_date}.xlsx"'
        wb.save(response)
        return response
    ...
    def export_customer_ledger_excel(self, customer_id=None):
        ...
        response = HttpResponse(content_type='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
        response['Content-Disposition'] = f'attachment; filename="customer_ledger_{self.start_date}_to_{self.end_date}.xlsx"'
        wb.save(response)
        return response
